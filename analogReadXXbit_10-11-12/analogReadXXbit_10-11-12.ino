...
void setup() 
{
  ...
  analogReference(INTERNAL); //define Vref = Internal = 1.1V
}
...
void do_a_bunch_of_samples(unsigned long num_samples)
{
  ...
  Serial.print((float)analogRead(A0)/MAX_READING_10_bit*Vref,8);//default
  Serial.print("\t");
  /*
  //10-bit ADC reading
  ...
  V = analog_reading/MAX_READING_10_bit*Vref; //voltage
  //Print the results
  ...
  V = analog_reading/MAX_READING_11_bit*Vref; //voltage
  //Print the results
  ...
  */
  ...
  V = analog_reading/MAX_READING_12_bit*Vref; //voltage
  //Print the results
  ...
  V = analog_reading/MAX_READING_13_bit*Vref; //voltage
  //Print the results
